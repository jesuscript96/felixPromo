  ...
  return (
    <section id="inicio" className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-12 lg:px-24 xl:px-32 pb-32 xl:pb-48">
        ...
        >
          <p className="text-xs md:text-sm xl:text-base tracking-[0.2em] uppercase mb-2 text-white/75 font-semibold">
            {s['Etiqueta Superior'] ?? 'Promoción'}
          </p>
          <h1 className="text-[54px] md:text-[86px] xl:text-[110px] 2xl:text-[130px] font-heading font-medium mb-2 tracking-tight leading-none text-white/95">
            {config['Nombre Promoción'] ?? 'NARA Moncada'}
          </h1>
          <p className="text-xs md:text-sm xl:text-base tracking-[0.3em] uppercase font-medium mb-12 xl:mb-16 text-white/80">
            {config['Tagline Hero'] ?? 'Vanguardia y Diseño en el eje norte de Valencia'}
          </p>

          <p className="text-base md:text-lg xl:text-xl font-light mb-4 text-white/85">
            {config['Descripción Hero'] ?? 'A un paso del CEU y a 20 minutos de Valencia'}
          </p>
          <h2 className="text-[32px] md:text-[43px] xl:text-[56px] 2xl:text-[64px] font-heading font-medium leading-tight mb-10 xl:mb-14 text-white/95">
