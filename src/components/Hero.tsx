...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-start h-full px-6 md:px-12 lg:px-24 pt-24 md:pt-32 lg:pt-36">
        <motion.div
        ...
        >
          ...
          <div className="inline-block px-8 py-4 border border-[#1F4D33]/50 backdrop-blur-sm hover:bg-[#1F4D33] hover:text-white transition-all duration-300 cursor-pointer">
